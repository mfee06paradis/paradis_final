...
const sql_fetchAll = `SELECT * FROM orderdetail`;
...
const sql_findByOrderId = `SELECT * FROM orderdetail where orderId = ?`;


const sql_addOrderDetailsById = `INSERT INTO orderdetail (orderId, productId, originalProductPrice, originalProductDiscount, discountPrice, quantity, discountId) VALUES ?`;
